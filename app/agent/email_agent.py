...
class EmailAgent:
    ...
    def generate_introduction(self, ranked_articles: List[Dict[str, Any]]) -> EmailIntroduction:
...
Generate a greeting and introduction that previews these articles."""
    ...
    def create_email_digest(self, ranked_articles: List[Dict[str, Any]], limit: int = 10) -> EmailDigest:
